...
import { globalSearchFunc } from "@/lib/actions/general.action";
...
const GlobalSearchResult = () => {
  ...
  // ⁡⁣⁢⁣𝗙𝗲𝘁𝗰𝗵 𝗔𝗹𝗹 𝗗𝗮𝘁𝗮 according to type and globalSearch⁡
  useEffect(() => {
    const fetchResult = async () => {
      ...
      try {
        ...
        const res = await globalSearchFunc({
          query: globalSearch,
          type,
        });
